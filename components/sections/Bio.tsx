    ...
    <section className="py-12 md:py-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          ...
          gestion d&apos;équipe, organisation, optimisation des process et
          pilotage opérationnel.
        </p>
        <p className="text-gray-700 leading-relaxed">
          Aujourd&apos;hui, animé par une passion de longue date pour le
          digital, je souhaite me réorienter vers le no code et
          l&apos;intelligence artificielle. Cette transition s&apos;inscrit à la
